...
class ChecklistForm(forms.Form):
    ...
    exits_enclosure_provided = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    exits_enclosure_construction = forms.CharField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    exits_fire_doors_provided = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    exits_fire_door_construction = forms.CharField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    stairs_count = forms.IntegerField(required=False, widget=forms.NumberInput(attrs={'class': 'form-control'}))
    stairs_enclosure_provided = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    stairs_enclosure_construction = forms.CharField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    stairs_fire_doors_provided = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    stairs_fire_door_construction = forms.CharField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    ...
    fire_extinguisher_count = forms.IntegerField(required=False, widget=forms.NumberInput(attrs={'class': 'form-control'}))
    fire_extinguisher_accessible = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    fire_extinguisher_conspicuous_location = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    ...
    control_panel_functional = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))

    hazardous_materials = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    hazardous_materials_properly_stored = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
