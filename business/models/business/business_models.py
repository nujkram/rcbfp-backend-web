...
class Business(models.Model):
  ...
  # === Relationship Fields ===
  region = models.ForeignKey('locations.Region', blank=True, default=6, null=False, on_delete=models.CASCADE, related_name='region_business')
  province = models.ForeignKey('locations.Province', blank=True, default=22, null=False, on_delete=models.CASCADE, related_name='province_business')
  city = models.ForeignKey('locations.City', blank=True, default=381, null=False, on_delete=models.CASCADE, related_name='province_business')
