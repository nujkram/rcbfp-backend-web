"""
rcbfp 0.0.1
Roxas City Bureau of Fire Protection

Account model

---
Mark
mark@springvalley.tech
"""
import logging
...
from accounts.models.managers.account_managers import AccountManager
...
class Account(AbstractBaseUser):
    ...
    user_type = models.CharField(choices=USER_TYPE_CHOICES, max_length=60, default=None, null=True, blank=True)
