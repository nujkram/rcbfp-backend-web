...
def checklists(businesses):

    counter = 0
    for business in businesses:
        year = str(business.building.date_of_construction.year + 1)
        schedule = DateDim.objects.get_days_between(start=str(business.building.date_of_construction), end=f'{year}-12-31')
