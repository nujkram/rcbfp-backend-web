...
class ChecklistForm(forms.Form):
    # TODO: Double check boolean fields
    ...
    horizontal_exit_capacity = forms.IntegerField(required=False, widget=forms.NumberInput(attrs={'class': 'form-control'}))
    ...
    travel_distance_within_limit = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    adequate_illumination = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    panic_hardware_operational = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    ...
    dead_ends_within_limits = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    proper_rating_illumination = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    door_swing_in_the_direction_of_exit = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    self_closure_operational = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    mezzanine_with_proper_exits = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    corridors_of_sufficient_size = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    ...
    main_stair_any_enclosure_provided = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    ...
    main_stair_door_proper_rating = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    main_stair_door_provided_with_vision_panel = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    main_stair_door_vision_panel_built = forms.CharField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    main_stair_pressurized_stairway = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    ...
    fire_escape_obstruction = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    discharge_of_exits = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    fire_escape_any_enclosure_provided = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    ...
    fire_escape_opening_protected = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    ...
    fire_door_door_proper_rating = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    fire_door_door_provided_with_vision_panel = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    fire_door_door_vision_panel_built = forms.CharField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    fire_door_pressurized_stairway = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    fire_door_type_of_pressurized_stairway = forms.CharField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))

    horizontal_exit_width = forms.IntegerField(required=False, widget=forms.NumberInput(attrs={'class': 'form-control'}))
    horizontal_exit_construction = forms.CharField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    horizontal_exit_vision_panel = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    horizontal_exit_door_swing_in_direction_of_egress = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    horizontal_exit_with_self_closing_device = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    horizontal_exit_corridor_width = forms.IntegerField(required=False, widget=forms.NumberInput(attrs={'class': 'form-control'}))
    horizontal_exit_corridor_construction = forms.CharField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    horizontal_exit_corridor_walls_extended = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    horizontal_exit_properly_illuminated = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    horizontal_exit_readily_visible = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    horizontal_exit_properly_marked = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    horizontal_exit_with_illuminated_directional_sign = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    horizontal_exit_properly_located = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    ...
    ramps_fire_doors_width = forms.IntegerField(required=False, widget=forms.NumberInput(attrs={'class': 'form-control'}))
    ramps_fire_doors_construction = forms.CharField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    ramps_with_self_closing_device = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    ramps_door_with_proper_rating = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    ramps_door_with_vision_panel = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    ramps_door_vision_panel_built = forms.CharField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    ramps_door_swing_in_direction_of_egress = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    ramps_obstruction = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    ramps_discharge_of_exit = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    ...
    safe_refuge_fire_door_width = forms.IntegerField(required=False, widget=forms.NumberInput(attrs={'class': 'form-control'}))
    safe_refuge_fire_door_construction = forms.CharField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    safe_refuge_with_self_closing_device = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    safe_refuge_door_proper_rating = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    safe_refuge_with_vision_panel = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    safe_refuge_vision_panel_built = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    safe_refuge_swing_in_direction_of_egress = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    ...
    emergency_light_per_floor_count = forms.IntegerField(required=False, widget=forms.NumberInput(attrs={'class': 'form-control'}))
    emergency_light_hallway_count = forms.IntegerField(required=False, widget=forms.NumberInput(attrs={'class': 'form-control'}))
    emergency_light_stairway_count = forms.IntegerField(required=False, widget=forms.NumberInput(attrs={'class': 'form-control'}))
    emergency_light_operational = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    emergency_light_exit_path_properly_illuminated = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    emergency_light_tested_monthly = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    ...
    exit_signs_min_letter_size = forms.IntegerField(required=False, widget=forms.NumberInput(attrs={'class': 'form-control'}))
    exit_route_posted_on_lobby = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    exit_route_posted_on_rooms = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    ...
    vertical_openings_properly_protected = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    vertical_openings_atrium = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    fire_doors_good_condition = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    elevator_opening_protected = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    pipe_chase_opening_protected = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    aircon_ducts_with_dumper = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    garbage_chute_protected = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    between_floor_protected = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    standpipe_type = forms.CharField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    standpipe_tank_capacity = forms.IntegerField(required=False, widget=forms.NumberInput(attrs={'class': 'form-control'}))
    standpipe_location = forms.CharField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    siamese_intake_provided = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    ...
    siamese_intake_accessible = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))

    fire_hose_cabinet = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    fire_hose_cabinet_accessories = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    fire_hose_cabinet_location = forms.CharField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    fire_hose_per_floor_count = forms.IntegerField(required=False, widget=forms.NumberInput(attrs={'class': 'form-control'}))
    ...
    portable_fire_extinguisher_capacity = forms.IntegerField(required=False, widget=forms.NumberInput(attrs={'class': 'form-control'}))
    portable_fire_extinguisher_count = forms.IntegerField(required=False, widget=forms.NumberInput(attrs={'class': 'form-control'}))
    portable_fire_extinguisher_with_ps_mark = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    portable_fire_extinguisher_with_iso_mark = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    portable_fire_extinguisher_maintained = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    ...
    portable_fire_extinguisher_accessible = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    portable_fire_extinguisher_other_type = forms.CharField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    sprinkler_system_agent_used = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    ...
    maintaining_line_pressure = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    ...
    heads_per_floor_count = forms.IntegerField(required=False, widget=forms.NumberInput(attrs={'class': 'form-control'}))
    ...
    lpg_installation_with_permit = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    fuel_with_storage_permit = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    ...
    generator_bound_on_wall = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    ...
    generator_output_capacity = forms.IntegerField(required=False, widget=forms.NumberInput(attrs={'class': 'form-control'}))
    generator_mechanical_permit = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    generator_fuel_storage_permit = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    generator_others = forms.CharField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    generator_automatic_transfer_switch = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    ...
    refuse_handling_enclosure = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    refuse_handling_fire_protection = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    ...
    separation_fire_rated_count = forms.IntegerField(required=False, widget=forms.NumberInput(attrs={'class': 'form-control'}))
    separation_fire_rated_capacity = forms.IntegerField(required=False, widget=forms.NumberInput(attrs={'class': 'form-control'}))
    separation_fire_rated_accessible = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    separation_fire_rated_fuel = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    separation_fire_rated_location = forms.CharField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    separation_fire_rated_permit = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))

    hazardous_material = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    hazardous_material_stored = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    fire_brigade_organization = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    fire_safety_seminar = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    employee_trained_in_emergency_procedures = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    evacuation_drill_first = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    evacuation_drill_second = forms.BooleanField(required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
